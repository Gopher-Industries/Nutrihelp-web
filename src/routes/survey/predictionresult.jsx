      ...
      {result ? (
        <div className="result-info-container">
          <div className="result-card-simple">
            <div className="result-row">
              ...
              <span className="result-value">
                <span className="result-main-value">
                  {humanizePredictionLabel(result.obesity_prediction?.obesity_level || result.medical_report?.obesity_level)}
                </span>
                {result.obesity_prediction?.confidence !== undefined ? (
                  <span className="result-confidence">
                    ...
                    <span className="result-confidence">
                      {renderConfidence(result.probability)}
                    </span>
                ) : null}
              </span>
            </div>
            ...
            {/* Recommendations Section from FE13SurveyForm */}
