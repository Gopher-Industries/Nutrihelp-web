  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Private Routes */}
        <Route path='createRecipe' element={<AuthenticateRoute><CreateRecipe /></AuthenticateRoute>} />
        <Route path='searchRecipes' element={<AuthenticateRoute><SearchRecipes /></AuthenticateRoute>} />
        <Route path='yourPreferences' element={<AuthenticateRoute><YourPreferences /></AuthenticateRoute>} />
        <Route path='userProfile' element={<AuthenticateRoute><UserProfilePage /></AuthenticateRoute>} />
        <Route path='Appointment' element={<AuthenticateRoute><Appointment /></AuthenticateRoute>} />
        <Route path='dietaryRequirements' element={<AuthenticateRoute><DietaryRequirements /></AuthenticateRoute>} />
        <Route path='ScanProducts' element={<AuthenticateRoute><ScanProducts /></AuthenticateRoute>} />
        <Route path='menu' element={<AuthenticateRoute><Menu /></AuthenticateRoute>} />
        <Route path='recipe' element={<AuthenticateRoute><Recipe /></AuthenticateRoute>} />
        <Route path='Meal' element={<AuthenticateRoute><Meal /></AuthenticateRoute>} />
        <Route path='MFAform' element={<MFAform />} />
        <Route path='dashboard' element={<AuthenticateRoute><Dashboard /></AuthenticateRoute>} />
      </Routes>
    </Router>
  );
}
